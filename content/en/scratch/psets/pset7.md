...
# Project 7: Variables - CS50's Introduction to Programming with Scratch
...
Your assignment is to create a game in Scratch that uses a **variable** to keep track of the player’s score.
...
3. Go to [submit.cs50.io/upload/cs50/problems/2024/scratch/variables](http://submit.cs50.io/upload/cs50/problems/2024/scratch/variables).
4. Click “Choose File” and choose your `.sb3` file. Click **Submit**.

If you encounter the error “No files in this directory are expected by cs50/problems/2024/scratch/variables”, please make sure your scratch project file name indeed ends with `.sb3`!
