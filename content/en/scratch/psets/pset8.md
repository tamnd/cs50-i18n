...
# Project 8: Abstraction - CS50's Introduction to Programming with Scratch
...
Your assignment is to revise one of the projects you’ve already created. Find some sequence of blocks that you use multiple times, and organize them into a **custom block**.
...
3. Go to [submit.cs50.io/upload/cs50/problems/2024/scratch/abstraction](http://submit.cs50.io/upload/cs50/problems/2024/scratch/abstraction).
4. Click “Choose File” and choose your `.sb3` file. Click **Submit**.

If you encounter the error “No files in this directory are expected by cs50/problems/2024/scratch/abstraction”, please make sure your scratch project file name indeed ends with `.sb3`!
