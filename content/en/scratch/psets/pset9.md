...
# Project 9: Building from Scratch - CS50's Introduction to Programming with Scratch
...
If *any* of the above nine requirements are missing, your project will not pass, so make sure they’re all present!
...
Unlike most other problems in the course, you must get get a score of 100% on `check50` in order to pass. This is an exception to the course’s ordinary expectation that a score of 70% is considered a passing grade. Do be aware!
...
3. Go to [submit.cs50.io/upload/cs50/problems/2024/scratch/build](http://submit.cs50.io/upload/cs50/problems/2024/scratch/build).
4. Click “Choose File” and choose your `.sb3` file. Click **Submit**.

If you encounter the error “No files in this directory are expected by cs50/problems/2024/scratch/build”, please make sure your scratch project file name indeed ends with `.sb3`!
