...
# Project 6: Loops - CS50's Introduction to Programming with Scratch
...
Your assignment is to create a Scratch project where a sprite repeats some behavior multiple times. Your project should include:

The below requirements are *distinct*. You must have both kinds of loops in your project!
...
3. Go to [submit.cs50.io/upload/cs50/problems/2024/scratch/loops](http://submit.cs50.io/upload/cs50/problems/2024/scratch/loops).
4. Click “Choose File” and choose your `.sb3` file. Click **Submit**.

If you encounter the error “No files in this directory are expected by cs50/problems/2024/scratch/loops”, please make sure your scratch project file name indeed ends with `.sb3`!
