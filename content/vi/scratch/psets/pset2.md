...
Nhiệm vụ của bạn là tạo một hoạt ảnh (animation) bằng Scratch. Dự án của bạn phải bao gồm:

- Ít nhất một khối **Chuyển động** (Motion).
- Ít nhất một khối **Hiển thị** (Looks).
- Ít nhất một khối **Âm thanh** (Sound).
...
3. Truy cập [submit.cs50.io/upload/cs50/problems/2024/scratch/functions](http://submit.cs50.io/upload/cs50/problems/2024/scratch/functions).
4. Nhấp vào “Choose File” và chọn tệp `.sb3` của bạn. Nhấp vào **Submit**.

Nếu bạn gặp lỗi “No files in this directory are expected by cs50/problems/2024/scratch/functions”, hãy đảm bảo tên tệp dự án Scratch của bạn thực sự kết thúc bằng `.sb3`!
