...
1. Đăng nhập vào [cs50.dev](https://cs50.dev) bằng tài khoản GitHub của bạn **sử dụng Chrome, Edge, hoặc Safari**, không dùng Firefox
...
3. Nộp [Scrabble](scrabble/)
4. Nộp [Readability](readability/)
5. Nộp một trong các bài sau:
   
   - [Caesar](caesar/), nếu bạn cảm thấy ít tự tin hơn
   - [Substitution](substitution/), nếu bạn cảm thấy tự tin hơn
...
- Thử chạy bất kỳ chương trình nào của David từ lớp học thông qua các ví dụ của [Week 2](../../weeks/2/).
- Để xem các trang hướng dẫn (manual pages) cho các hàm C, hãy truy cập [manual.cs50.io](https://manual.cs50.io/).
...
- [Caesar - CS50x 2026](../problems/psets-2-caesar.md)
- [Readability - CS50x 2026](../problems/psets-2-readability.md)
- [Scrabble - CS50x 2026](../problems/psets-2-scrabble.md)
- [Substitution - CS50x 2026](../problems/psets-2-substitution.md)
