...
Truy cập [scratch.mit.edu](https://scratch.mit.edu/) và đăng nhập vào tài khoản của bạn. Nhấp vào nút "Khởi tạo" (Create) để tạo một dự án mới.

Nhiệm vụ của bạn là tạo một dự án Scratch nơi một nhân vật (sprite) lặp lại một hành vi nào đó nhiều lần. Dự án của bạn phải bao gồm:

Các yêu cầu dưới đây là *riêng biệt*. Bạn phải có cả hai loại vòng lặp trong dự án của mình!

- Ít nhất một khối **liên tục** (forever).
- Ít nhất một khối **lặp lại** (repeat).
...
3. Truy cập [submit.cs50.io/upload/cs50/problems/2024/scratch/loops](http://submit.cs50.io/upload/cs50/problems/2024/scratch/loops).
4. Nhấp vào “Choose File” và chọn tệp `.sb3` của bạn. Nhấp vào **Submit**.

Nếu bạn gặp lỗi “No files in this directory are expected by cs50/problems/2024/scratch/loops”, hãy đảm bảo tên tệp dự án Scratch của bạn thực sự kết thúc bằng `.sb3`!
...
Để xem tiến độ hiện tại của bạn trong khóa học, hãy truy cập sổ điểm tại [cs50.me/cs50s](https://cs50.me/cs50s)!
